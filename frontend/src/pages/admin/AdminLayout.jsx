...
import { LayoutDashboard, Users, UserCheck, CalendarDays, BarChart2, Settings, Shield } from 'lucide-react';
...
const PAGE_TITLES = {
  ...
  '/admin/doctors':      { title:'Doctor Management',sub:'Manage doctors & departments' },
  '/admin/appointments': { title:'All Appointments', sub:'Platform-wide appointment log' },
